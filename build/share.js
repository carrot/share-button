(function() {
  $.fn.sharer = function(opts) {
    ...
    toggle = function(e) {
      e.stopPropagation();
      return $(this).parent().find('.social').toggleClass('active');
    };
    open = function() {
      return $(this).parent().find('.social').addClass('active');
    };
    close = function() {
      return $(this).parent().find('.social').removeClass('active');
    };
    click_link = function() {
      var link;
